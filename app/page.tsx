          ...
          <div className="mb-8 border-b pb-8">
            ...
            <div className="mb-4">
              ...
              <ul className="list-disc list-inside text-gray-600 space-y-1">
                ...
                <li>
                  <code className="bg-gray-100 px-1 rounded">pageSize</code> -
                  每页数量（默认: 20，最大: 100）
                </li>
                <li>
     ...
     "${baseUrl}/api/list?categoryId=1&subCategoryId=2&page=1&pageSize=20"`}
          ...
          <div className="mb-8 border-b pb-8">
            ...
            <div className="mb-4">
              ...
              <ul className="list-disc list-inside text-gray-600 space-y-1">
                <li>
                  <code className="bg-gray-100 px-1 rounded">id</code> - 视频
                  vod_id
                </li>
              </ul>
            </div>
            <div className="bg-gray-50 rounded p-4">
              ...
              <p className="text-xs font-mono text-gray-700 break-all whitespace-pre-wrap">
                {`curl -H "Authorization: Bearer YOUR_API_KEY" \\
     "${baseUrl}/api/detail?vodId=27196"`}
              </p>
            </div>
          </div>
              ...
              <tbody className="divide-y divide-gray-200">
                <tr>
                  <td className="px-4 py-3 text-sm">
                    <code className="bg-red-100 px-1 rounded">200</code>
                  </td>
                  <td className="px-4 py-3 text-sm text-gray-700">成功</td>
                </tr>
                <tr>
                  <td className="px-4 py-3 text-sm">
                    <code className="bg-yellow-100 px-1 rounded">400</code>
                  </td>
                ...
                <tr>
                  <td className="px-4 py-3 text-sm">
                    <code className="bg-yellow-100 px-1 rounded">404</code>
                  </td>
                  <td className="px-4 py-3 text-sm text-gray-700">
                    资源不存在
                  </td>
                ...
                <tr>
                  <td className="px-4 py-3 text-sm">
                    <code className="bg-red-100 px-1 rounded">500</code>
                  </td>
                  <td className="px-4 py-3 text-sm text-gray-700">
                    服务器内部错误
                  </td>
                ...
                <tr>
                  <td className="px-4 py-3 text-sm">
                    <code className="bg-red-100 px-1 rounded">503</code>
                  </td>
                  <td className="px-4 py-3 text-sm text-gray-700">
                    服务不可用
                  </td>
