...
export default function ApiConfigPage() {
  ...
  const handleGenerateApiKey = async () => {
    const confirmed = window.confirm('确定要自动生成新的 API Key 吗？这将替换当前的 API Key。');
    if (!confirmed) return;
            ...
            <>
              <div className="bg-white rounded-lg shadow p-6 mb-6">
                <div className="flex items-center justify-between">
                  ...
                  >
                    {saving ? '切换中...' : config.auth_enabled ? '关闭认证' : '开启认证'}
                  </button>
                </div>
              </div>
              ...
              <div className="bg-white rounded-lg shadow p-6 mb-6">
                ...
                <p className="text-gray-600 text-sm mb-4">
                  限制每个 IP 地址的 API 调用频率，防止恶意请求。始终生效，不受认证开关影响。
                </p>
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
                ...
                <ul className="text-sm text-blue-800 space-y-1">
                  ...
                  <li>请求头格式: <code className="bg-blue-100 px-1 rounded">Authorization: Bearer YOUR_API_KEY</code></li>
                  <li>建议使用自动生成的 API Key，定期更换以提高安全性</li>
                  <li>速率限制始终生效，不受认证开关影响，每个 IP 地址独立计算</li>
